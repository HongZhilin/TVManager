...
import cn.edu.zjut.util.ReflectHelper;
...
//					String countSql = "select count(0) from (" + sql+ ") as tmp_count"; //记录统计
					...
					if(parameterObject instanceof Page){ //参数就是Page实体
						 ...
						 page.setEntityOrField(true);	 //见cn.edu.zjut.entity.Page.entityOrField 注释
						...
						if(pageField!=null){
							...
							if(page==null)
								page = new Page();
							page.setEntityOrField(false); //见cn.edu.zjut.entity.Page.entityOrField 注释
							page.setTotalResult(count);
