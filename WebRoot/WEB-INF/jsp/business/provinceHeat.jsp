...
<script type="text/javascript">
    $(function () {
        ...
        var arr15=[];
        $.ajax({
            url: "${pageContext.request.contextPath}/business/getProvinceHeatData.html",
            type: 'GET',
            dataType: 'json',
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if(data[i].time=="2015/11/02"){
                        arr2.push(data[i]);
                    }
                    if(data[i].time=="2015/11/03"){
                        arr3.push(data[i]);
                    }
                    if(data[i].time=="2015/11/04"){
                        arr4.push(data[i]);
                    }
                    if(data[i].time=="2015/11/05"){
                        arr5.push(data[i]);
                    }
                    if(data[i].time=="2015/11/06"){
                        arr6.push(data[i]);
                    }
                    if(data[i].time=="2015/11/07"){
                        arr7.push(data[i]);
                    }
                    if(data[i].time=="2015/11/08"){
                        arr8.push(data[i]);
                    }
                    if(data[i].time=="2015/11/09"){
                        arr9.push(data[i]);
                    }
